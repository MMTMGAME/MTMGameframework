...
namespace GameMain.Editor.DataTableTools
{
    public sealed partial class MTDataTableProcessor
    {
        ...
        public MTDataTableProcessor(string dataTableFileName, Encoding encoding, int nameRow, int typeRow, int? defaultValueRow, int? commentRow, int contentStartRow, int idColumn)
        {

...
namespace GameMain.Editor.DataTableTools
{
    public sealed class DataTableGenerator
    {
        ...
        public static DataTableProcessor CreateDataTableProcessor(string dataTableName,string outFolder,string TempleFile)
        {
            CSharpCodeTemplateFileName = TempleFile;
            DataTablePath = outFolder;
            return new DataTableProcessor(Utility.Path.GetRegularPath(dataTableName), Encoding.GetEncoding("GB2312"), 1, 2, null, 3, 4, 1);
        }
